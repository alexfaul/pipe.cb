...
ext = 'dff.mat';
dffDir = findFilePathAF(fullRoot,ext); %should come after running dff calculation so that you have the index positions of each run and the ops.xoff and ops.yoff
                                    % alternatively, 
...
%% Create graphs for shock if they exist
