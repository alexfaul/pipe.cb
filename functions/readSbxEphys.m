...
title(['Vis Stim Trace and Licking',mouse,'_',num2str(date),'_', num2str(run)])
hold off

%%%%%%%%% find onsets and offsets and shock onsets and offsets,, make d' of
%%%%%%%%% behavior when shock or ensure is triggered
