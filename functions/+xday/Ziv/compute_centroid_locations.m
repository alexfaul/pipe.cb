function [centroid_locations]=compute_centroid_locations(spatial_footprints,microns_per_pixel,typical_cell_size)
...
if nargin>3, typical_cell_size=10; end % in micrometers - determines the radius that is used for gaussfit
normalized_typical_cell_size=typical_cell_size/microns_per_pixel(1);
